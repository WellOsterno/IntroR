...
Alguns outros tipos de gráficos são interessantes. Na tabela abaixo temos alguns dos principais tipos e exemplos básicos. Para facilitar, vamos utilizar dados fictícios.

|           Gráfico            |         Exemplo de dados fictícios         |
|:---------------------------:|:-----------------------------------------:|
|          **Barras**          |      Número de habitantes por região       |
|     **Barras agrupadas**     |        População por sexo e região         |
|    **Barras empilhadas**     |           Escolaridade por sexo            |
